...
# ===== 原始 parquet 路径 =====
parquet_path = "/root/autodl-tmp/zz/datasets/AI-ModelScope/LaTeX_OCR/human_handwrite/validation-00000-of-00001.parquet"
...
# ===== 自动生成输出路径 =====
output_jsonl = os.path.join(parent_dir, f"{parquet_file_name}_rlhf.jsonl")
...
for idx, sample in enumerate(dataset):
    ...
    query = "Convert this image to LaTeX."
    solution = sample.get("text", "")
